...
const AdminTechnicians: React.FC = () => (
  <div className="space-y-6">
    <div>
      <h1 className="text-2xl lg:text-3xl font-bold text-foreground">Technicians</h1>
      <p className="text-muted-foreground mt-1">Manage technicians</p>
    </div>
        ...
        <table className="w-full">
          ...
          <tbody>
            <tr><td colSpan={4} className="px-6 py-12 text-center text-muted-foreground">
              ...
              Technician data will load from admin API
            </td></tr>
          </tbody>
        </table>
      </div>
